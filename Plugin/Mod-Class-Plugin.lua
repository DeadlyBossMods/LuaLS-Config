...
local function addFullModClassComment(ast, varNode, className)
	...
	-- UNIT_*
	astHelper.addDoc(ast, varNode, "field", "UNIT_AURA fun(self: " .. className .. ", uId: string, updateInfo: table)", group)
	astHelper.addDoc(ast, varNode, "field", "UNIT_AURA_UNFILTERED fun(self: " .. className .. ", uId: string, updateInfo: table)", group)
	astHelper.addDoc(ast, varNode, "field", "UNIT_POWER_UPDATE fun(self: " .. className .. ", uId: string, powerType: string)", group)
	astHelper.addDoc(ast, varNode, "field", "UNIT_POWER_UPDATE_UNFILTERED fun(self: " .. className .. ", uId: string, powerType: string)", group)
